    ...
    <div className='space-y-8'>
      ...
      <div className='flex flex-col gap-4'>
        <div className='flex items-center justify-between'>
          <div className='inline-flex items-center gap-4 rounded-full border border-slate-200/80 bg-slate-50/50 px-4 py-1.5 text-sm dark:border-slate-800/50 dark:bg-slate-900/50'>
          ...
          <Button
            ...
            {expandedCards.size === projects.length
              ? '모두 접기'
              : '모두 펼치기'}
            <motion.div
              animate={{
